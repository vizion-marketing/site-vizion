        ...
        <div className="max-w-2xl mb-12 sm:mb-16 lg:mb-20">
          ...
          {description && (
            <motion.p
              ...
              className={`mt-4 text-[15px] sm:text-base font-[var(--font-body)] leading-relaxed ${isDark ? "text-white/60" : "text-[#6b6b6b]"}`}
            >
              {description}
            </motion.p>
          )}
              ...
              return (
                ...
                >
                  ...
                  <div className={`pb-8 sm:pb-10 ${index < steps.length - 1 ? `border-b ${isDark ? "border-white/5" : "border-black/5"}` : ""} flex-1`}>
                    ...
                    <p className={`text-[14px] sm:text-[15px] font-[var(--font-body)] leading-relaxed max-w-xl ${isDark ? "text-white/60" : "text-[#6b6b6b]"}`}>
                      {step.description}
                    </p>
                  </div>
                </motion.div>
