...
<Figure
  src="/images/cas-clients/easyvirtual-product.jpg"
  alt="Interface de visite virtuelle easyVirtual.tours"
  caption="La technologie easyVirtual.tours : des visites virtuelles 360° qui accélèrent de 32% le temps de vente des biens immobiliers."
  type="mockup"
/>
...
<Figure
  src="/images/cas-clients/easyvirtual-kit-marketing.jpg"
  alt="Kit marketing franchisé easyVirtual.tours"
  caption="Le kit marketing complet remis à chaque franchisé : templates, guides, et supports de vente prêts à l'emploi."
  type="default"
/>
...
<MockupBrowser
  src="/images/cas-clients/easyvirtual-dashboard-leads.jpg"
  alt="Dashboard de pilotage des leads easyVirtual.tours"
  url="app.easyvirtual.tours/dashboard"
  caption="Le dashboard de pilotage réseau : visibilité en temps réel sur la performance de chaque franchisé."
/>
...
<Figure
  src="/images/cas-clients/easyvirtual-map-france.jpg"
  alt="Carte des 25 agences easyVirtual.tours en France"
  caption="Couverture nationale : 25 agences déployées en 18 mois sur le territoire français."
  type="chart"
/>
